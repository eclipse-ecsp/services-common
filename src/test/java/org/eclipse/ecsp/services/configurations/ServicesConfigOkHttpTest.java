...
@TestPropertySource("classpath:/rest-template-test-okhttp.properties")
class ServicesConfigOkHttpTest extends ServicesConfigTestBase {
    private static final IgniteLogger LOGGER = IgniteLoggerFactory.getLogger(ServicesConfigOkHttpTest.class);
    public static final int RESPONSE_CODE_200 = 200;
    public static final int RESPONSE_CODE_404 = 404;
    public static final int DELAY_IN_SEC = 11;
    ...
    void responseDelay() {
        server.enqueue(
            new MockResponse().setResponseCode(RESPONSE_CODE_200).setBody("ok")
                .setHeadersDelay(DELAY_IN_SEC, TimeUnit.SECONDS)
        );
